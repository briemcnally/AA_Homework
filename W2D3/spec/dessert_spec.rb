...
describe Dessert do
  let(:chef) { double("chef", name: "Brie") }
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Brie the Amazing Chef")
      expect(cookie.serve).to eq("Brie the Amazing Chef has made 20 cookies!")
    end
  end
